                ...
                <div className="flex items-center space-x-1">
                  {( [
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded cursor-pointer transition ${orbitSpeed === speed.val ? 'bg-stone-900 text-white font-bold' : 'text-stone-600 hover:bg-stone-150 hover:text-stone-950'}`}
                    >
                      {speed.label}
                    </button>
                  ))}
