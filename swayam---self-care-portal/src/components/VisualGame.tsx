...
export const VisualGame: React.FC = () => {
  ...
  const [orbitSpeed, setOrbitSpeed] = useState<number>(0.012); // slow
          ...
          <div className="relative border border-stone-150/60 rounded-2xl bg-stone-50/50 flex flex-col justify-center items-center overflow-hidden py-4 min-h-[300px]">
            {!isPlayingOrbit ? (
              <div className="absolute inset-0 bg-white/75 backdrop-blur-xs flex flex-col items-center justify-center text-center p-6 space-y-4 z-10 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-stone-850 text-stone-50 flex items-center justify-center">
                ...
                <button
                  ...
                  className="bg-stone-900 hover:bg-stone-850 px-5 py-2.5 rounded-xl text-stone-50 text-xs font-bold transition shadow-sm cursor-pointer"
                >
                ...
                <div className="flex items-center space-x-1">
                  {( [
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded ${orbitSpeed === speed.val ? 'bg-stone-850 text-white' : 'hover:bg-stone-100 hover:text-stone-800'}`}
                    >
                      {speed.label}
                    </button>
                  ))}
