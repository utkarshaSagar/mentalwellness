      ...
      <div id="backup-controllers" className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
        ...
        <div id="box-export" className="space-y-3">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center space-x-1.5 bg-stone-900 hover:bg-stone-800 text-stone-50 px-4 py-3 rounded-xl cursor-pointer text-xs font-medium transition"
          >
